...
?>
            <div class="module-head">
                <h3>Edit your project data</h3>
            </div>
            <div class="module-body">
            <?php 
                $querySelect = "SELECT * FROM project WHERE id='$editId'";
            ...
            ?>
                <form class="form-horizontal row-fluid" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="batch" name="contributors" value="<?php echo $result['contributors']; ?>" class="span8">
                        </div>
                    </div>
                    <div class="control-group">
